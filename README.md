...
После того, как вы выбрали нужные файлы, необходимо написать сообщения для коммита. После этого нажать на галочку.  
![VSCCheck](pic/VSCCheck.PNG)  
Чтобы отправить наши изменения на гитхаб необходимо:
